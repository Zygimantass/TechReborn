...
public class TileDieselGenerator extends TileMachineInventory implements IFluidHandler {

	public static final int euTick = ConfigTechReborn.ThermalGeneratorOutput;
	public Tank tank = new Tank("TileDieselGenerator", Fluid.BUCKET_VOLUME * 10, this);

	public TileDieselGenerator() {
//		super(ConfigTechReborn.ThermalGeneratorTier);
		super(EnumPowerTier.LOW, );
	}
